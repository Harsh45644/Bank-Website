...
<body style="background-image:url('back2.png'); padding-top:8%;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="harsh.jpeg.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:coral;">This website is designed by</p>
            <h1 style="color:gray; text-shadow:2px 2px 2px gray;">Harsh Patel</h1>
            <p style="color:gray;"><b> as an Intern at Sparks Foundation <br>Bhopal</b></p>
    </center>
