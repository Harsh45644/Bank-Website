...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="securelogo..png" alt=""
                    style="height: 100px; margin-left:25px; margin-top:10px;"></a>
    ...
    <div class="container-large"
        style="color:green; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:black;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Secure
                        Bank!</b></p>
            </div>
            <div class="col" style="margin: 2px;0% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="bank8.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="background2.jpg" alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Our Amazing Facilities</b></h1>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <h6>In this, you can watch every customer of the bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>On click on this, you can send money from your account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
